 ...
 */
    ...
    ?>
	<form id="homepage-contact-form" action="<?php echo esc_url( $_SERVER['PHP_SELF'] . '#contact-area' ); ?>" method="post">
		<textarea name="contact-message" onfocus="if ( this.value == '<?php esc_attr_e( 'Your Message', 'woothemes' ); ?>' ) { this.value = ''; }" onblur="if ( this.value == '' ) { this.value = '<?php esc_attr_e( 'Your Message', 'woothemes' ); ?>'; }"><?php if ( isset( $_GET['contact-message'] ) ) { esc_attr_e( $_GET['contact-message'] ); } else { esc_attr_e( 'Your Message', 'woothemes' ); } ?></textarea>
		<div class="col-right">
			<input type="text" name="contact-name" value="<?php if ( isset( $_GET['contact-name'] ) ) { esc_attr_e( $_GET['contact-name'] ); } else { esc_attr_e( 'Name and Surname', 'woothemes' ); } ?>" onfocus="if ( this.value == '<?php esc_attr_e( 'Name and Surname', 'woothemes' ); ?>' ) { this.value = ''; }" onblur="if ( this.value == '' ) { this.value = '<?php esc_attr_e( 'Name and Surname', 'woothemes' ); ?>'; }" />
			<input type="text" name="contact-email" value="<?php if ( isset( $_GET['contact-email'] ) ) { esc_attr_e( $_GET['contact-email'] ); } else { esc_attr_e( 'Your email address', 'woothemes' ); } ?>" onfocus="if ( this.value == '<?php esc_attr_e( 'Your email address', 'woothemes' ); ?>' ) { this.value = ''; }" onblur="if ( this.value == '' ) { this.value = '<?php esc_attr_e( 'Your email address', 'woothemes' ); ?>'; }" />
			...
			<input type="submit" value="<?php esc_attr_e( 'Contact Us!', 'woothemes' ); ?>" />
		</div>
	</form>
	<?php } ?>