...
add_action( 'tgmpa_register', 'palette_canvas_register_required_plugins' );
/**
 ...
 */
function palette_canvas_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/assets/plugins/wooslider.zip', // The plugin source.
